...
function f.childValue(prop, value, obj)
    ...
    if parentPropType == "Vector3" then
        return Vector3.new(propName == "X" and value or objProp.X, propName == "Y" and value or objProp.Y, propName == "Z" and value or objProp.Z)
    elseif parentPropType == "Rect2D" then
        return Rect.new(propName == "X0" and value or objProp.Min.X, propName == "Y0" and value or objProp.Min.Y, propName == "X1" and value or objProp.Max.X, propName == "Y1" and value or objProp.Max.Y)
    end
end
...
function f.getChildProp(prop, data)
    ...
    local childNode = {
        ...
        Control = f.getPropControl(newProp, {
            data.Name,
        }),
        Depth = data.Depth,
        Children = {},
